...
<head>
    ...
    <link href="../fontend/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
    ...
    <link href="../fontend/css/sb-admin-2.min.css" rel="stylesheet">
    <link href="../fontend/css/app.css" rel="stylesheet">
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="../image/Logo_Web-01.png" height="60px">
                </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/promotion">Danh sách đề</a>
                        <a class="collapse-item" href="/form-diencauhoi">Tạo đề</a>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-toggle="collapse" data-target="#Introduce" aria-expanded="true"
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
            <a class="nav-link collapsed" data-toggle="collapse" data-target="#mon" aria-expanded="true"
                    aria-controls="Address">
                    <i class="fas fa-fw fa-folder"></i>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small"><?=Session::get('TK')?></span>
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-success" id="alert" role="alert">
                        <a class="closebtn" onclick="nhan()">&times;</a>
    ...
    <script src="../fontend/js/sb-admin-2.min.js"></script>
    <script>
    tinymce.init({
        selector: '#textarea'
    });
