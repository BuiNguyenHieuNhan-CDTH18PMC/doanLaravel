    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{URL::to('/login')}}" enctype="multipart/form-data" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="d-flex justify-content-center">
                        <input class="btn btn-primary m-1" type="submit" value="Đăng nhập">
                        <a href="/register" class="btn btn-primary m-1">Đăng kí</a>
                    </div>
                </form>
            </div>
        </div>
